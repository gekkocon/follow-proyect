...
export function Sidebar({ open, onClose }: SidebarProps) {
  ...
  const nav = (
    <>
      {/* Logo */}
      <div className="flex h-14 md:h-16 items-center px-5 border-b border-border shrink-0">
  ...
  return (
    <>
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-3 right-3 rounded-md p-2 text-muted-foreground hover:text-foreground z-10"
        >
          <X size={18} />
        </button>
        {nav}
