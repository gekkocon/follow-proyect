...
41. reorderPhases (paso 3a, Etapa 3) no es atómica: un loop secuencial de updates individuales, sin transacción. Si falla a mitad de camino, las fases anteriores al fallo ya quedaron con su nuevo sort_order escrito y las posteriores no — inconsistencia acotada pero real. Misma familia que las deudas 26 y 30 (no-atomicidad de PostgREST en createPhase y moveTaskToPhase). El reorder de tareas (paso 3b) va a heredar el mismo patrón salvo que se decida lo contrario antes.
